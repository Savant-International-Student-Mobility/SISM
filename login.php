...
// Kung naka-login na siya, ididirekta na agad sa home page
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user && password_verify($password, $user['password'])) {
        // Kapag tama, i-save ang info sa session at pumunta sa index.php
...
<body>
  <a href="index.php" class="btn-back-circle" title="Back to Home">
    ...
    <div class="glass-card">
      <div class="row align-items-center">
        ...
        <div class="col-lg-6">
          ...
          <?php if($error): ?>
              <div class="alert alert-danger py-2 mb-3 small"><?php echo $error; ?></div>
          <?php endif; ?>
